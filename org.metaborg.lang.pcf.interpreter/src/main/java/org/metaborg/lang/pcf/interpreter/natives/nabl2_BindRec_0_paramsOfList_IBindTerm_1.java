...
@SuppressWarnings("unused") @NodeChild(value = "term", type = TermBuild.class) public abstract class nabl2_BindRec_0_paramsOfList_IBindTerm_1 extends NaBL2TermBuild 
{ 
  public nabl2_BindRec_0_paramsOfList_IBindTerm_1 (SourceSection source) 
  { 
    super(source);
  }
  ...
  { 
    return nabl2_BindRec_0_paramsOfList_IBindTerm_1NodeGen.create(source, term);
  }
}