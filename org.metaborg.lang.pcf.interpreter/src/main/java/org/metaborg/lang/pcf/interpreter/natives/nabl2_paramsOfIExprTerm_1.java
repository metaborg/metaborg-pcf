...
@SuppressWarnings("unused") @NodeChild(value = "term", type = TermBuild.class) public abstract class nabl2_paramsOfIExprTerm_1 extends NaBL2TermBuild 
{ 
  public nabl2_paramsOfIExprTerm_1 (SourceSection source) 
  { 
    super(source);
  }

  @Specialization public IScopeTerm doGet(IExprTerm term)
  { 
  ...
  { 
    return nabl2_paramsOfIExprTerm_1NodeGen.create(source, term);
  }
}